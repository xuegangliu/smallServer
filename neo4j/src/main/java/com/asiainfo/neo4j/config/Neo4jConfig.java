package com.asiainfo.neo4j.config;
...
@EnableNeo4jRepositories(basePackages = { "com.asiainfo.neo4j.repositories" })
...
//    }
    ...
    public SessionFactory getSessionFactory() {
        return new SessionFactory("com.asiainfo.neo4j.domain");
    }
}
